...
import CustomizedDialogs3 from './Dialog3'
    ...
    <>
      ...
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button variant="outlined" >
            ...
            <CustomizedDialogs title="Add Category" type="Category">
            <CatForm  />
          </CustomizedDialogs>
            </Button>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, visibility, avatarUrl, createdAt, } = row;
      ...
      >
        <MenuItem sx={{ color: 'green' }}>
          ...
          <CustomizedDialogs title={"Edit"} type="Category">
            <CatForm 
              id={img_obj.id}
              cat_name={img_obj.name}
        ...
        <MenuItem sx={{ color: 'blue' }}>
          <Iconify icon={'material-symbols:grid-view-rounded'} sx={{ mr: 3 }} />
          <CustomizedDialogs3>
            <SubCatPage id={img_obj.id} />
          </CustomizedDialogs3>
        </MenuItem>
      </Popover>
      {
