...
// mock
import {getData} from '../_mock/products';
...
const TABLE_HEAD = [
  { id: 'name', label: 'Festival Name', alignRight: false },
  { id: 'image_visibility', label: 'Image Visibility', alignRight: false },
    ...
    <>
      ...
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button variant="outlined" >
            ...
            <CustomizedDialogs title="Add Image" type="Image">
            <Form  />
          </CustomizedDialogs>
            </Button>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, image_visibility, year, amount, avatarUrl, createdAt, } = row;
                    ...
                    return (
                      <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="left">{(image_visibility == 1) ? 'TRUE' : 'FALSE'}</TableCell>
      ...
      >
        <MenuItem sx={{ color: 'green' }}>
          ...
          <CustomizedDialogs title={"Edit"} type="Image">
            <Form 
              id={img_obj.id}
              name={img_obj.name}
              image_visibility={img_obj.image_visibility}
              year={img_obj.year}
              amount={img_obj.amount}
              avatarUrl={img_obj.avatarUrl}
